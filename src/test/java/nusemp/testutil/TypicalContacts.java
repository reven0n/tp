...
public class TypicalContacts {
    ...
    public static final Contact ELLE = new ContactBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withoutAddress().build();
    public static final Contact FIONA = new ContactBuilder().withName("Fiona Kunz").withEmail("lydia@example.com")
            .withoutPhone().withAddress("little tokyo").build();
    public static final Contact GEORGE = new ContactBuilder().withName("George Best").withEmail("anna@example.com")
            .withoutPhone().withoutAddress().build();
    ...
    public static final Contact AMY = new ContactBuilder().withName(VALID_CONTACT_NAME_AMY)
    ...
    public static final Contact BOB = new ContactBuilder().withName(VALID_CONTACT_NAME_BOB)
