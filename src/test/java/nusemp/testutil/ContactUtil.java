...
public class ContactUtil {
    ...
    public static String getAddCommand(Contact contact) {
        return CommandType.CONTACT + " " + ContactAddCommand.COMMAND_WORD + " " + getContactDetails(contact);
    }
     ...
     */
    public static String getEditContactDescriptorDetails(ContactEditCommand.EditContactDescriptor descriptor) {
        StringBuilder sb = new StringBuilder();
