 ...
 * As such, adding and updating of contacts uses Contact#isSameContact(Contact) for equality so as to ensure that the
 * contact being added or updated is unique in terms of identity in the UniqueContactList.
 * However, the removal of a contact uses Contact#equals(Object) so as to ensure that the contact with exactly the
