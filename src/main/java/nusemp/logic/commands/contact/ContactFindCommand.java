...
public class ContactFindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = CommandType.CONTACT + " " + COMMAND_WORD
            ...
            + "Examples:\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " alice bob\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " --name alice\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " --email gmail\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " --phone 9123\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " --address serangoon\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " --tag friend\n"
            + "  " + CommandType.CONTACT + " " + COMMAND_WORD + " --name alice bob --email gmail\n"
            + "  (matches contacts where name contains 'alice' OR 'bob' AND email contains 'gmail')";
